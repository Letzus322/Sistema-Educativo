...
class Profile_model extends MY_Model
{
    ...
    public function studentUpdate($data, $reservation = 0)
    {
        ...
        if (isset($data['permanent_address'])) {
            $arrData['permanent_address'] = $data['permanent_address'];
        }
        
        if (isset($data['present_address'])) {
            $arrData['current_address'] = $data['present_address'];
        }
        ...
        else  { $this->db->where('id',$reservation);}
    ...
    public function parentUpdateReservation($data,$idParent)
    {
        $update_data = array(
            'name' => $data['name'],
            'relation' => $data['relation'],
            ...
            'mobileno' => $data['mobilenoParent'],
            'address' => $data['addressParent'],
            'city' => $data['cityParent'],
            'state' => $data['stateParent'],
            'photo' => $this->uploadImage('parent'),
            'facebook_url' => $data['facebook'],
            'linkedin_url' => $data['linkedin'],
            'twitter_url' => $data['twitter'],
