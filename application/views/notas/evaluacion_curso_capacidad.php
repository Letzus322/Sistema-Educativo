		...
		<div class="tab-content">
			<div class="tab-pane active">
				...
				<div class="row">
                        ...
                        <?php $competencia_assign_id = $competencia['id'];

                        $query = $this->db->get_where('subject_assign_capacidades', array('competencia_assign_id' => $competencia_assign_id));
						...
						<section class="panel panel-custom">
							<header class="panel-heading panel-heading-custom">
                                ...
                                <h4 class="panel-title">Competencia: <?php echo $competencias['name'];?></h4>
                                ...
                                <table class="table responsive-table">
                                    ...
                                    <thead>
                                        <tr style="background-color: #4CAF50;">
                                            <th colspan="6" style="text-align: center; background-color: green; color: white;">Competencia  </th>
                                        ...
                                        <tr class="no-border">
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control font-weight-bold" value="<?= $competencia['name'] ?>" disabled="">
                                                </div>
                                            </td>
                                            ...
                                            <td style="display: none;">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control font-weight-bold" value="0" id="cantidadCapacidades" disabled="">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-inline-block dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="agregarCapacidad(document.getElementById('cantidadCapacidades').value)">
                                                ...
                                                <div class="d-inline-block dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo base_url('notas/evaluacion_curso_indicador_crear/' .$row['id']);?>"     onclick="">
...
function agregarCapacidad(competenciaID) {
    ...
    var nuevaCantidad = parseInt(document.getElementById('cantidadCapacidades').value) + 1;

    document.getElementById('cantidadCapacidades').value = nuevaCantidad;  
        ...
        $("#guardarCambios").on("click", function () {
            ...
            for ($i = 1; $i <= 10; $i++): ?>
                ...
                var capacidadesData = {
                    ...
                    subject_assign_id:  <?php echo $competencia['id'];?>,
                };


                postData.capacidades.push(capacidadesData);
            <?php endfor; ?>
            ...
            for ($i = 1; $i < $count; $i++): ?>
                ...
                postData.capacidadesActualizar.push(capacidadesData);
            <?php endfor; ?>

            $.ajax({
                type: "POST",
                url: base_url + 'Notas/evaluacion_curso_capacidades_agregar',
                data: postData,
