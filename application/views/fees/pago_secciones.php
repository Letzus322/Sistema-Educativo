					...
					<table class="table table-bordered table-condensed table-hover mb-none tbr-top table-export">
						...
						<tbody>
							...
							<tr>
                                ...
                                <td><?= mb_strtoupper($row['last_name'], 'UTF-8').' '.mb_strtoupper($row['first_name'], 'UTF-8') ?></td>
								...
								<td><?php echo $currency_symbol . (isset($row['total_discount']) ? $row['total_discount'] : 0); ?></td>

								<td><?php echo $currency_symbol . ($row['full_amount'] - $row['total_discount']);?></td>
