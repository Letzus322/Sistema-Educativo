            ...
            <section class="container">
                <div class="row">
                    <div class="col-md-6" style="margin: auto 0;">
                        <h1>Pago de Admisión</h1>
                        <h4>El Pago del Estudiante: <strong style="color: #5e5e5e;"><?php echo $get_student['last_name'] . " " . $get_student['first_name'] ?></strong> </h4>
