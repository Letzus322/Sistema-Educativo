...
<div class="breadcrumb">
    <div class="container px-md-0">
        <ul class="list-unstyled list-inline">
            <li class="list-inline-item"><a href="<?php echo base_url('home') ?>">Inicio</a></li>
    ...
    <div class="box2 form-box">
        <div class="tabs-panel tabs-product">
            <div class="nav nav-tabs">
                <a class="nav-item nav-link active" data-toggle="tab" href="#new-admission" role="tab" aria-controls="tab-details" aria-selected="true">Nueva Admision</a>
            </div>
            <div class="tab-content clearfix">
                <div class="tab-pane fade show active" id="new-admission" role="tabpanel" aria-labelledby="tab-new-admission">
                    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal frm-submit-data')); ?>
                        ...
                        <div class="headers-line mt-3"><i class="fas fa-school"></i> Detalles Académicos</div>
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $section['status'] == 1 ? '4' : '6' ?>">
                                <div class="form-group">
                                    ...
                                    <?php
                                        $arrayClass = $this->app_lib->getClassAdmision($branchID);
                        ...
                        <?php if ($section['status']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Sección<?php echo $section['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                    <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label for="admission_date">Fecha de Admisión<?php echo $admission_date['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label for="admission_date">Categoria<?php echo $category['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                    <?php
                        ...
                        <div class="headers-line mt-3"><i class="fas fa-user-graduate"></i> Detalles del Estudiantes</div>
                        <div class="row">
                            <?php 
                            ...
                            <div class="col-md-<?php echo $div ?> mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Nombres Completos <span class="required">*</span></label>
                            ...
                            <div class="col-md-<?php echo $div ?> mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Apellidos<?php echo $last_name['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?> mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Genero<?php echo ($gender['required'] == 1 ? ' <span class="required">*</span>' : ''); ?></label>
                                    <?php
                                        $arrayGender = array(
                                            '' => translate('select'),
                                            'male' => translate('male'),
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label for="mobile_no">N° celular Estudiante<?php echo $student_mobileno['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label for="email">Email de Estudiante<?php echo $student_email['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label class="control-label">Dirección Actual<?php echo $current_address['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?> mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Ciudad<?php echo $city['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?> mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Distrito<?php echo $state['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-sm">
                                <div class="form-group">
                                    <label for="message">Foto de Estudiante<?php echo $student_photo['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="photoFile">Seleccione Archivo...</label>
                                    </div>
                                    <span class="error"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Nombre de Colegio<?php echo $previous_school_details['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-6 mb-sm">
                                <div class="form-group">
                                    <label class="control-label">Calificación<?php echo $previous_school_details['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        ?>
                        <div class="headers-line mt-3"><i class="fas fa-user-tie"></i> Detalles del Apoderado</div>
                        <?php 
                        $div = 6;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label class="control-label">Nombres y Apellidos del Apoderado<?php echo $guardian_name['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label class="control-label">Relación (madre o padre)<?php echo $guardian_relation['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label for="father_name">Nombres y Apellidos del Padre<?php echo $father_name['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label for="mother_name">Nombres y Apellidos de la Madre<?php echo $mother_name['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label class="control-label">Email de Apoderado<?php echo $guardian_email['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label class="control-label">N° de Celular de Apoderado<?php echo $guardian_mobile_no['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="guardian_document_type">Tipo de Documento del Apoderado <?php echo $guardian_document_type['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                    <select class="form-control" name="guardian_document_type">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="guardian_document">DNI de Apoderado <?php echo $guardian_document['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                    <input type="text" class="form-control" name="guardian_document" placeholder="" value="<?php echo set_value('guardian_document'); ?>">
                                    <span class="error"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="message">Dirección de Apoderado <?php echo $guardian_address['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-<?php echo $div ?>">
                                <div class="form-group">
                                    <label class="control-label">Ciudad de Apod3erado<?php echo $guardian_city['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="message">Foto de Apoderado<?php echo $guardian_photo['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="guardianPhoto">Seleccionar foto...</label>
                                    </div>
                                    <span class="error"></span>
                                </div>
                            </div>
                        ...
                        ?>
                        <div class="headers-line mt-3"><i class="far fa-file-archive"></i> subir documentos</div>
                        <div class="form-group">
                    ...
                    <?php } ?>
                        ...
                        <button type="submit" class="btn btn-1" id="submit-btn" data-loading-text="<i class='fas fa-spinner fa-spin'></i> Processing" disabled>
                            <i class="fas fa-plus-circle"></i> Enviar
                        </button>
                        <?php echo form_close(); ?>
                </div>
            </div>
