			...
			<div class="panel-body">
				...
				<div id="guardian_form">
					...
					<div class="row">
						...
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								<label class="control-label"><?=translate('Dni Padre')?><?php echo $guardian_email['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="dni_parent" class="form-control" name="dni_parent" id="dni_parent" value="<?=set_value('dni_parent', $stuDetails['dni_parent'])?>" />
								</div>
