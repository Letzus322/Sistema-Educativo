<?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'frm-submit-data')); ?>
    <div class="panel">
        ...
        <?php if (!$documentos[0]['subidaArchivos'] || !$documentos[0]['citaAcademica']||!$documentos[0]['citaPsicologica']) : ?>
        ...
        <?php else : ?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="archivo1" name="archivo1" accept=".pdf" required>
                </div>
