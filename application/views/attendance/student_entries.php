...
<a href="<?php echo base_url('/lectorqr/mark_attendance.php' . $row['student']);?>" class="btn btn-default pull-left btn-circle icon" data-toggle="tooltip"
								data-original-title="<?=translate('scan_qr')?>">
...
<a href="<?php echo base_url('/lectorqrmolino/mark_attendance.php' . $row['staff']);?>" class="btn btn-default pull-left btn-circle icon" data-toggle="tooltip"
								data-original-title="<?=translate('scan_qr')?>">
									<i class="fas fa-qrcode"></i>
								</a>
...
<a href="<?php echo base_url('/lectorqrmoche/mark_attendance.php' . $row['staff']);?>" class="btn btn-default pull-left btn-circle icon" data-toggle="tooltip"
								data-original-title="<?=translate('scan_qr')?>">
									<i class="fas fa-qrcode"></i>
								</a>
...
<a href="<?php echo base_url('/lectorqrsanandres/mark_attendance.php' . $row['staff']);?>" class="btn btn-default pull-left btn-circle icon" data-toggle="tooltip"
								data-original-title="<?=translate('scan_qr')?>">
									<i class="fas fa-qrcode"></i>
								</a>
						
<a href="<?php echo base_url('/lectorqracademia/mark_attendance.php' . $row['staff']);?>" class="btn btn-default pull-left btn-circle icon" data-toggle="tooltip"
								data-original-title="<?=translate('scan_qr')?>">
									<i class="fas fa-qrcode"></i>
								</a>
