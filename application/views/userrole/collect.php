...
if (count($allocations)) {
	...
	<?php endif; ?>
				...
				<li >
					<a href="#upload_receipt" data-toggle="tab"><i class="far fa-credit-card"></i> <?=translate('Subir comprobante de pago')?></a>
				</li>
			</ul>
			<div class="tab-content">
									...
									<tbody>
										<?php
											...
											foreach ($allocations as $row) {
												...
												///////
												$this->db->where('allocation_id',$row['allocation_id']);
												$this->db->where('type_id',  $row['fee_type_id']);
												$query = $this->db->get('descuentos');
												$descuento = $query->row();
												////
												$type_discount = $descuento->discount;
										...
										<tr>
											...
											<td><?php echo $currency_symbol . $fine;?></td>
				...
				<div id="upload_receipt" class="tab-pane">
						<div class="mb-xlg">
					

						<?php echo form_open('feespayment/subircomprobantepago', array('class' => 'frm-submit-data' )); ?>
							<input type="hidden" name="invoice_no" value="<?=$invoice['invoice_no']?>">
							<div class="form-group">
								<label class="col-md-3 control-label"><?=translate('fees_type')?> <span class="required">*</span></label>
								<div class="col-md-6">
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?=translate('Numero de operación')?> <span class="required">*</span></label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="numero_operacion" id="numero_operacion" value="" autocomplete="off" />
									<span class="error"></span>
								</div>
							</div>
						
							<div class="form-group">
								<label class="col-md-3 control-label"><?=translate('Fecha de operacion')?> <span class="required">*</span></label>
								<div class="col-md-6">

								<input type="date" name="fecha_operacion" id="fechaOperacion" class="form-control" required>
								</div>
							...
							<div class="form-group">
								<label class="col-md-3 control-label"><?=translate('Comprobante de pago')?> <span class="required">*</span></label>
								<div class="col-md-6">
							...
							<footer class="panel-footer">
								<div class="row">
									<div class="col-md-offset-3 col-md-3">
										<button type="submit" class="btn btn-default" data-loading-text="<i class='fas fa-spinner fa-spin'></i> Processing">
											<i class="fas fa-credit-card"></i> <?=translate('Subir comprobante')?>
										</button>
									</div>
								</div>
							</footer>
