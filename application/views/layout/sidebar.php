                ...
                <ul class="nav nav-main">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'admission') echo 'nav-expanded nav-active';?>">
                        ...
                        <?php if(get_permission('student', 'is_add')){ ?>
                            ...
                            <li class="nav-parent <?php if ($sub_page_2 == 'interna') echo 'nav-expanded nav-active';?>">
                                <a>
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('Interna')?></span>
                                </a>
                                <!-- Submenú desplegable -->
                                <ul class="nav nav-children">
                                
                                    <li class="<?php if ($sub_page == 'vacancy_reservation/vistaAdmin') echo 'nav-active';?>">
                                        <a href="<?=base_url('student/reserva')?>">
                                            <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('Reserva Matricula')?></span>
                                        </a>
                            ...
                            <li class="nav-parent <?php if ($sub_page_2 == 'externa') echo 'nav-expanded nav-active';?>">
                                <a>
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('Externa')?></span>
                                </a>
                                <!-- Submenú desplegable -->
                                <ul class="nav nav-children">
                                    ...
                                    <?php  if(get_permission('enviar_contrato', 'is_view')){ ?>
                                        <li class="<?php if ($sub_page == 'secretaria/enviarDocumentoNiveles' ) echo 'nav-active';?>">
                                            <a href="<?=base_url('student/enviarDocumentoNiveles')?>">
                                                <span><i class="fas fa-caret-right" aria-hidden="true"></i> Documentos por Niveles  </span>
                                            </a>
                                        </li>
                                    <?php } ?>

                                    <?php  if(get_permission('revisar_contrato', 'is_view')){ ?>
                                        <li class="<?php if ($sub_page == 'secretaria/revisarContrato' ) echo 'nav-active';?>">
                                            <a href="<?=base_url('student/revisarContrato')?>">
                                                <span><i class="fas fa-caret-right" aria-hidden="true"></i> Revisar Contrato</span>
                                            </a>
                                        </li>
                                    <?php } ?>
                        ...
                        <?php  if(get_permission('add_cita_academica', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'citas/citaAcademicaSecretaria') echo 'nav-active';?>">
                                    <a href="<?=base_url('student/CitaAcademicaSecretaria')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i>Cita Academica</span>
                                    </a>
                                </li>
                                <?php } ?>
                                <?php  if(get_permission('add_cita_psicologica', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'citas/citaPsicologicaSecretaria' ) echo 'nav-active';?>">
                                    <a href="<?=base_url('student/CitaPsicologicaSecretaria')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i> Cita Psicologica</span>
                                    </a>
                                </li>
                            <?php } ?>

                            <?php  if(get_permission('ver_estado_matricula', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'secretaria/verEstadoMatricula' ) echo 'nav-active';?>">
                                    <a href="<?=base_url('student/verEstadoMatricula')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i> Ver estado matricula</span>
                                    </a>
                                </li>
                            <?php } ?>
                            ...
                            <?php /*  <?php  if(get_permission('enviar_contrato', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'secretaria/enviarContrato' ) echo 'nav-active';?>">
                                    <a href="<?=base_url('student/EnviarContrato')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i> Enviar Contrato Nuevos </span>
                                    </a>
                                </li>
                            <?php } ?>
                            ...
                            <?php  if(get_permission('enviar_contrato', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'secretaria/enviarContratoAntiguos' ) echo 'nav-active';?>">
                                    <a href="<?=base_url('student/EnviarContratoAntiguos')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i> Enviar Contrato Antiguos </span>
                                    </a>
                                </li>
                            <?php } ?>   */ ?>
                    ...
                    get_permission('class_timetable', 'is_view') ||  get_permission('registrar_notas', 'is_view')) {
                    ?>
                    <!-- academic -->
                    <li class="nav-parent <?php if ($main_menu == 'classes' ||
                                                        $main_menu == 'sections' ||
                                                            $main_menu == 'timetable' ||
                                                                $main_menu == 'subject' ||
                                                                    $main_menu == 'transfer'||
                                                                    $main_menu =='subject/class_assign'|| $main_menu =='temarios'
                                                                    || $main_menu =='solucionarios') echo 'nav-expanded nav-active';?>">
                        <a>
                        ...
                        <ul class="nav nav-children">
                            ...
                            get_permission('subject_class_assign', 'is_view') ||
                            get_permission('subject_teacher_assign', 'is_view') ||
                            get_permission('registrar_notas', 'is_view'))
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'subject') echo 'nav-expanded';?>">
                                ...
                                <a>
                                    <i class="fas fa-book-reader"></i><?=translate('Cursos y Areas')?>
                                </a>
                                ...
                                <li class="<?php if ($sub_page == 'notas/bimestre' ) echo 'nav-active';?>">
                                    <a href="<?=base_url('Notas/bimestre')?>">
                                        <span><i class="fas fa-dna" aria-hidden="true"></i><?=translate('Bimetres/Unidad') ?></span>
                                    </a>
                                </li>

                                <li class="<?php if ($sub_page == 'notas/evaluacion' ) echo 'nav-active';?>">
                                    <a href="<?=base_url('Notas/evaluacion')?>">
                                        <span><i class="fas fa-dna" aria-hidden="true"></i><?=translate('Evaluación') ?></span>
                                    </a>
                                </li>
                                ...
                                <?php  if(get_permission('registrar_notas', 'is_view') ){ ?>
                                
                                
                                <li class="<?php if ($sub_page == 'notas/registrar_notas') echo 'nav-active';?>">
                                    <a href="<?=base_url('notas/registrar_notas')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i>Registrar Notas</span>
                                    </a>
                                </li>
                                
                                <li class="<?php if ($sub_page == 'temarios/tema_dictado') echo 'nav-active';?>">
                                    <a href="<?=base_url('temarios/tema_dictado')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i>Registrar Tema Dictado</span>
                                    </a>
                                </li>
                                ...
                                <?php  if(get_permission('libreta_notas', 'is_view') ){ ?>
                                
                                
                                <li class="<?php if ($sub_page == 'libretas/ver_aulas') echo 'nav-active';?>">
                                    <a href="<?=base_url('libretas/ver_aulas')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i>Libreta de Notas</span>
                                    </a>
                                </li>
                                ...
                                <?php  if(get_permission('exonerar_curso', 'is_view') ){ ?>
                                
                                
                                <li class="<?php if ($sub_page == 'notas/exonerar_curso') echo 'nav-active';?>">
                                    <a href="<?=base_url('notas/exonerar_curso')?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i>Exonerar curso</span>
                                    </a>
                                </li>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'temarios') echo 'nav-expanded';?>">
                                <?php if(get_permission('subject', 'is_view')) { ?>

                                <a>
                                    <i class="fas fa-book-reader"></i>Temarios
                                </a>
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'temarios/index' || $sub_page == 'temarios/edit') echo 'nav-active';?>">
                                        <a href="<?=base_url('temarios/index')?>">
                                            <span><?=translate('Crear')?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'solucionarios') echo 'nav-expanded';?>">
                                <?php if(get_permission('subject', 'is_view')) { ?>

                                <a>
                                    <i class="fas fa-book-reader"></i>Solucionarios
                                </a>
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'solucionarios/index' || $sub_page == 'temarios/edit') echo 'nav-active';?>">
                                        <a href="<?=base_url('solucionarios/index')?>">
                                            <span><?=translate('Subir')?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="<?php if ($sub_page == 'student/traslado') echo 'nav-active';?>">
                                <a href="<?=base_url('student/traslado')?>">
                                    <span><i class="fab fa-deviantart" aria-hidden="true"></i><?=translate('Traslado Sede')?></span>
                                </a>
                            </li>
                    ...
                    ?>
                    <!-- student accounting -->
                    <li class="nav-parent <?php if ($main_menu == 'fees' or $main_menu =='factura_electronica') echo 'nav-expanded nav-active';?>">
                        <a>
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li class="<?php if ($sub_page == 'fees/type') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/type')?>"><span><i class="fas fa-caret-right"></i><?=translate('fees_type')?></span></a>
                            </li>
                            <?php } if(get_permission('fees_group', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'fees/group') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/group')?>"><span><i class="fas fa-caret-right"></i><?=translate('fees_group')?></span></a>
                            </li>
                            <?php } if(get_permission('fees_fine_setup', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'fees/fine_setup') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/fine_setup')?>"><span><i class="fas fa-caret-right"></i><?=translate('fine_setup')?></span></a>
                            </li>
                            <?php } if(get_permission('fees_allocation', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'fees/allocation') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/allocation')?>"><span><i class="fas fa-caret-right"></i><?=translate('fees_allocation')?></span></a>
                            </li>
                            ...
                            <li class="<?php if ($sub_page == 'fees/invoice_list' || $sub_page == 'fees/collect') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/invoice_list')?>"><span><i class="fas fa-caret-right"></i><?=translate('payments_history')?></span></a>
                            </li>

                            <li class="<?php if ($sub_page == 'fees/realizar_ventas' ) echo 'nav-active';?>">
                                <a href="<?=base_url('fees/realizar_ventas')?>"><span><i class="fas fa-caret-right"></i><?=translate('Realizar Ventas')?></span></a>
                            </li>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'factura_electronica') echo 'nav-expanded nav-active';?>">
                                <a>
                                    <i class="fas fa-file-invoice"></i><span><?=translate('Facturación Electrónica')?></span>
                                </a>
                                <ul class="nav nav-children">
                                    <?php if(get_permission('fees_type', 'is_view')) { ?>
                                    ...
                                    <li class="<?php if ($sub_page == 'factura_electronica/resumen_diario_boletas' ) echo 'nav-active';?>">
                                        <a href="<?=base_url('factura_electronica/resumen_diario_boletas')?>"><span><i class="fas fa-caret-right"></i><?=translate('Resumen diario de Boletas')?></span></a>
                                    </li>

                                    <li class="<?php if ($sub_page == 'factura_electronica/consulta_envio_individual' ) echo 'nav-active';?>">
                                        <a href="<?=base_url('factura_electronica/consulta_envio_individual')?>"><span><i class="fas fa-caret-right"></i><?=translate('Consulta de Envio Individual')?></span></a>
                                    </li>
                                    
                                    <li class="<?php if ($sub_page == 'factura_electronica/consulta_boletas_emitidas' ) echo 'nav-active';?>">
                                        <a href="<?=base_url('factura_electronica/consulta_boletas_emitidas')?>"><span><i class="fas fa-caret-right"></i><?=translate('Consulta de Boletas emitidas')?></span></a>
                                    </li>
                            ...
                            <li class="<?php if ($sub_page == 'fees/ver_documentos' ) echo 'nav-active';?>">
                                <a href="<?=base_url('fees/ver_documentos')?>"><span><i class="fas fa-caret-right"></i><?=translate('Ver Documentos')?></span></a>
                            </li>


                            <li class="<?php if ($sub_page == 'fees/ver_pagos' ) echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/ver_pagos')?>"><span><i class="fas fa-caret-right"></i><?=translate('Ver pagos')?></span></a>
                            </li>

                            <li class="<?php if ($sub_page == 'fees/reporte_deudas' ) echo 'nav-active';?>">
                                <a href="<?=base_url('fees/reporte_deudas')?>"><span><i class="fas fa-caret-right"></i><?=translate('Reporte deudas')?></span></a>
                            </li>
                          

                            <?php } if(get_permission('due_invoice', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'fees/due_invoice') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/due_invoice')?>"><span><i class="fas fa-caret-right"></i><?=translate('due_fees_invoice')?></span></a>
                            </li>

                            <li class="<?php if ($sub_page == 'fees/pago_secciones') echo 'nav-active';?>">
                                <a href="<?=base_url('fees/pago_secciones')?>"><span><i class="fas fa-caret-right"></i>Pago por secciones</span></a>
                            </li>

                            <?php } if(get_permission('fees_reminder', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'fees/reminder') echo 'nav-active';?>">
                                <a href="<?=base_url('fees2/reminder')?>"><span><i class="fas fa-caret-right"></i><?=translate('fees_reminder')?></span></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
                    ...
                    <?php
                    if(get_permission('crearHorario', 'is_view') ) {
                    ?>
                    <!-- office accounting -->
                    <li class="nav-parent <?php if ($main_menu == 'Citas') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="icon-credit-card icons"></i><span><?=translate('Citas')?></span>
                        </a>
                        <ul class="nav nav-children">
                            <?php if(get_permission('crearHorario', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'psicologo/crearHorario' || $sub_page == 'accounting/edit') echo 'nav-active'; ?>">
                                    <a href="<?php echo base_url('psicologo'); ?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Crear Horario'); ?></span>
                                    </a>
                                </li>

                            <?php if(get_permission('pendientes_citas', 'is_view')){ ?>

                                <li class="<?php if ($sub_page == 'psicologo/citasPendientes' || $sub_page == 'accounting/edit') echo 'nav-active'; ?>">
                                    <a href="<?php echo base_url('psicologo/citasPendientes'); ?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Citas Pendientes'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if(get_permission('enviar_resultados_psicologo', 'is_view')){ ?>

                            <li class="<?php if ($sub_page == 'psicologo/enviarResultado' || $sub_page == 'accounting/edit') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('psicologo/enviarResultado'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Enviar resultado Citas'); ?></span>
                                </a>
                            </li>
                    ...
                    <?php
                    if(get_permission('crearHorarioCitaAcademica', 'is_view') ) {
                    ?>
                    <!-- office accounting -->
                    <li class="nav-parent <?php if ($main_menu == 'Citas') echo 'nav-expanded nav-active';?>">
                        <a>
                        ...
                        <ul class="nav nav-children">
                            <?php if(get_permission('crearHorarioCitaAcademica', 'is_view')){ ?>
                                <li class="<?php if ($sub_page == 'auxiliar/crearHorario' || $sub_page == 'accounting/edit') echo 'nav-active'; ?>">
                                    <a href="<?php echo base_url('auxiliar'); ?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Crear Horario'); ?></span>
                                    </a>
                                </li>

                            <?php if(get_permission('pendientes_citas_academicas', 'is_view')){ ?>

                                <li class="<?php if ($sub_page == 'auxiliar/citasPendientes' || $sub_page == 'accounting/edit') echo 'nav-active'; ?>">
                                    <a href="<?php echo base_url('auxiliar/citasPendientes'); ?>">
                                        <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Citas Pendientes'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if(get_permission('enviar_resultados_academicos', 'is_view')){ ?>

                            <li class="<?php if ($sub_page == 'auxiliar/enviarResultado' || $sub_page == 'accounting/edit') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('auxiliar/enviarResultado'); ?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?php echo translate('Enviar resultado Citas'); ?></span>
                                </a>
                            </li>
