									...
									<div class="table-responsive">
										<table class="table table-bordered table-condensed mt-md">
											<thead>
												...
												<th><?=translate('vacantes')?> <span class="required">*</span></th>
												...
												foreach ($classArray as $key => $value) {
													...
													?>
												 	<tr>
														...
														<td width="20%">
														<div class="form-group">
															<input type="text" class="form-control" name="addmissionfee[<?=$key?>][vacantes]" value="<?=$vacantes?>" />
															<span class="error"><?php echo form_error('vacantes'); ?></span>
														</div>
														</td>
