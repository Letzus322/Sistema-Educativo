	...
	<div class="col-md-12">
		<div class="panel-group" id="accordion">
					...
					<div class="panel-body">
						...
						<div class="row mb-md">
							<div class="col-md-12 mb-md">
								...
								<div class="form-group">
									<?php
										$arrayParent = $this->app_lib->getSelectList('parent');
											//SE LE AGREGÓ 1 A ID, NO ENCUENTRO DONDE SE HACE LA LOGICA QUE CAMBIE ESTE DROPDOWN SEGÚN BRANCH
										echo form_dropdown("parent_id", $arrayParent, set_value('parent_id', $student['parent_id']), "class='form-control' id='parent_id1'
			...
			<div class="panel panel-accordion">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#documentosPostulacion">
							<i class="fas fa-folder"></i> <?=translate('Subir documentos de postulación')?>
						</a>
					</h4>
				</div>
				<?php echo form_open_multipart($this->uri->uri_string()); ?>
				<div id="documentosPostulacion" class="accordion-body collapse">
					<div class="panel-body">		
						...
						<?php else : ?>
							<div class="panel-body">
								...
								<div class="form-group mt-3"> <!-- Agrega un margen top (mt) de 3 -->
									<button type="submit" name="subirArchivo" value="1" class="btn btn-primary">Subir Archivo</button>
								</div>
							</div>
						<?php endif; ?>
						</div>
			...
			<div class="panel panel-accordion">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#verDocumentosPostulacion">
							<i class="fas fa-folder"></i> <?=translate('Ver documentos de postulación')?>
						</a>
					</h4>
				</div>
				<div id="verDocumentosPostulacion" class="accordion-body collapse">
					<div class="panel-body">		
				...
				<section class="panel">
					...
					<div class="panel-body">
						...
						<?php foreach ($documentosSubidos as $documento) : ?>
							
						<div class="card">
							<div class="card-body">
								<h5 class="card-title"><?php echo $documento['nombre_document']; ?></h5>
								<?php if (pathinfo($documento['ruta_archivo'], PATHINFO_EXTENSION) == 'pdf') : ?>
									<a href="<?php echo base_url('student/verPDF/'.$documento['ruta_archivo'].'?parametro='. $student['id']); ?>" target="_blank" class="btn btn-primary">
