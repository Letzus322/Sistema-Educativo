    ...
    public function approved($student_id = '')
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $valid_class_ids = ['1', '2', '3', '4', '25', '26', '27', '28', '44', '45', '46', '47', '63', '64', '65'];
                $class_id = $post['class_id'];
                ...
                if (in_array($class_id, $valid_class_ids)) {
                    ...
                    $this->db->insert('estadoMatricula', $arrayEstado);
                    ...
                    $this->db->insert('reservasAcademicas', $arrayReservas);
                }
                else {
                ...
                $valid_class_doc_ids = ['1', '25', '44','63'];
                $class_id = $post['class_id'];


                if (in_array($class_id, $valid_class_doc_ids)) {
                    $registroSubida = array(
                        'student_id' => $studentID,
                        'document_id' => 3,
                        'ruta_archivo' => 'No necesario',
