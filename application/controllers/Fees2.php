...
class Fees2 extends Admin_Controller
{
    ...
    public function ver_pagos()
    {
        ...
        if ($this->input->post('search')) {
            ...
            $this->db->select('comprobante_pago.id as id,s.first_name as first_name,comprobante_pago.amount as amount,comprobante_pago.date as date,
            fees_type.name as fees_type,comprobante_pago.numero_operacion as numero_operacion, s.last_name as last_name,c.name AS class_name, 
            se.name AS section_name , comprobante_pago.ruta as ruta, s.id as student_id')->from('comprobante_pago');
            $this->db->join('fee_allocation as fa', 'comprobante_pago.allocation_id = fa.id');
            $this->db->join('student as s', 'fa.student_id = s.id');
    ...
    public function delete_comprobante_pago($id = '')
    {
         
            $this->db->where('id', $id);
            $this->db->delete('comprobante_pago');
