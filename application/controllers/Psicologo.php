...
class Psicologo extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($_POST) {
           ...
           $psicologo_id =get_loggedin_user_id();
           $this->db->select('*');
        ...
        $this->data['sub_page'] = 'psicologo/crearHorario';
    ...
    public function aceptar() {
        $schedule_id = $this->input->post('student_id');
            // Datos a actualizar
        $data = array(
            'estado' => 'Aceptado'
        );
        ...
        $this->db->update('reservasPsicologicas', $data);
        // Hacer algo con $student_id, como actualizar la base de datos, etc.
    
        // Por ejemplo, imprimir el ID recibido para verificar
        ...
        estadoMatricula.citaPsicologica AS resultadoEnviado');
        $this->db->from('reservasPsicologicas rp');
        ...
        $this->data['sub_page'] = 'psicologo/citasPendientes';
    ...
    public function enviarResultado()
    {
        ...
        $this->db->join('parent', 'parent.id = s.parent_id');
        $this->db->where('ws.staff_id' ,get_loggedin_user_id());
        $this->db->where('rp.estado' ,'Aceptado');
        ...
        if ($_POST) {
           ...
           // $upload_dir = APPPATH . 'upload/';
            ...
            if (!empty($_FILES['archivo']['name'])) {
                ...
                $new_filename = 'ResultadosPsicologicos'.'_' . $estudiante['first_name'] .'_'. $estudiante['last_name'] . '.' . $file_extension;
            ...
            $this->db->update('reservasPsicologicas'); // Tabla que se va a actualizar
        ...
        $this->data['sub_page'] = 'psicologo/enviarResultado';
